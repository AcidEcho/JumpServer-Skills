...
DAILY_USAGE_EXAMPLES = [
    ...
    "python3 subskills/query/scripts/jms_report.py daily-usage --period 上周 --org-name Default",
    "python3 subskills/query/scripts/jms_report.py daily-usage --date-from '2026-03-10 00:00:00' --date-to '2026-03-24 23:59:59' --org-id 00000000-0000-0000-0000-000000000000",
]
